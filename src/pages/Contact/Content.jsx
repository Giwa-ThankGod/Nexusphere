...
import {
  ...
  faSpinner,
  faClose,
} from "@fortawesome/free-solid-svg-icons"; // Import FontAwesome flag icon
            ...
            <div className="flex flex-wrap justify-between">
              <div className="w-full md:w-1/3 pt-20 text-white">
                <h2 className="text-4xl text-center leading-tight">
                  Supercharge Your Growth <br /> Now!
                </h2>
                <p className="my-3 text-xl">
                  Team up with Nexusphere for a strategic partnership that
                  propelis you ahead of your competition.
                </p>
                ...
                <ul className="pl-4 text-xl">
                  <li className="my-3 flex gap-4">
                    ...
                    >
                      <path
                        d="M9.00016 19.1689L4.83016 14.9989L3.41016 16.4089L9.00016 21.9989L21.0002 9.99887L19.5902 8.58887L9.00016 19.1689Z"
                        fill="#04F339"
                      />
                    </svg>
                  </li>
              ...
              <div className="w-full md:w-1/2">
                <div className="bg-white border rounded-lg shadow-md py-6 px-3 my-5">
                  <h4 className="text-center font-medium">
                    We would love to hear from you and discuss how we can assist
                    you.
                  </h4>
                  <form
                    method="post"
                  ...
                  >
                    ...
                    <div className="relative flex items-center mt-1 mb-3">
                      ...
                      <div className="absolute flex flex-grow items-center">
                        <ReactFlagsSelect
                          className="text-2xl mt-1 border-0"
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        name="phone"
                        className="w-full m-0 p-2 pl-32 border rounded shadow-sm focus:outline-none focus:border-blue-500"
                        placeholder="80027389700"
                        required
                      />
                    </div>
                    ...
                    <input
                      ...
                      name="industry"
                      className="w-full px-3 pl-5 py-2 mt-1 mb-3 border rounded shadow-sm focus:outline-none focus:border-blue-500"
                      placeholder="Fintech, Web3, NFT , Blockchain"
                      required
                    />

                    <p className="mb-3">
                      What services do you need? (multiple options allowed)
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="flex align-item">
                        <input
                          type="checkbox"
                          value="Africa online services"
                          checked={services.opt1}
                      ...
                      <div className="flex align-item">
                        <input
                          type="checkbox"
                          value="Funding"
                          checked={services.opt6}
                          onChange={handleServices}
                          name="opt6"
                          className="checkbox mr-1 mb-3"
                        />
                    ...
                    {msg ? (
                      <div className="flex justify-between items-center cursor-pointer bg-purple-200 text-purple-900 px-5 py-2 my-2 rounded">
                        {msg}{" "}
                        <FontAwesomeIcon
                          onClick={handleCancleAlert}
                          icon={faClose}
                        />
                      </div>
                    ) : (
